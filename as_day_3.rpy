label as_day_3_spartakiada:
    ...
    jump as_day_3_day_library

label as_day_3_day_library:
    ...
    jump as_day_3_day_evening_square


label as_day_3_day_evening_square:
    ...
    jump as_day_3_day_evening_library


label as_day_3_day_evening_library:
    scene bg int_library_day with dissolve
    ...
    jump as_day_3_evening_alisa_encounter

label as_day_3_evening_alisa_encounter:
    scene bg ext_path_sunset with dissolve
    play ambience ambience_forest_evening fadein 2
    "Выходя из библиотеки, я решил сократить путь через кусты, чтобы быстрее добраться до домика. Мысли всё ещё крутились вокруг Лены и её холодной манеры — она вызывала уважение, но и лёгкую растерянность."
    "Вдруг из-за густых зарослей донеслись приглушённые голоса и смех. Я замер, прислушиваясь."
    th "Кто там? Пацаны?"
    "Я осторожно раздвинул ветки и выглянул. То, что я увидел, ударило как обухом по голове."
    scene bg ext_bushes_sunset with dissolve
    show dv laugh pioneer2 at left with dissolve
    show gr smile pioneer at right with dissolve
    "Алиса стояла, прижавшись к Грому, её руки обвивали его шею, а он держал её за талию. Они целовались — страстно, без стеснения, как будто весь мир вокруг исчез."
    dv "Ммм, Громыч, ты такой... сильный."
    gr "А ты, рыжая, как всегда, заводишь с пол-оборота."
    "Алиса хихикнула, отстранилась на миг и провела пальцем по его груди."
    dv "Не то что эти лохи из новичков. С тобой интереснее."
    th "Блядь... Это что, seriously? Алиса с этим уродом?"
    "Я почувствовал укол ревности — острый, как нож. Мы не встречались, но после всего, что было... это било по самолюбию."
    "Я хотел уйти, но нога предательски хрустнула под веткой."
    play sound sfx_bus_horn
    show dv surprise pioneer2 at left with hpunch
    show gr tender pioneer at right with dspr
    dv "Кто там?"
    "Алиса резко повернулась, её глаза встретились с моими. На миг в них мелькнуло удивление, но быстро сменилось знакомой игривой ухмылкой."
    show dv grin pioneer2 at left with dspr
    dv "О, комиссар! Подглядываешь? Не ожидала от тебя."
    me "Я... эээ... просто проходил мимо. Не хотел мешать вашему... эээ... романтическому моменту."
    "Мои слова вышли неловко, с ноткой сарказма, но внутри всё кипело. Гром усмехнулся, не отпуская Алису."
    gr "Новенький? А ты смелый, подслушиваешь. Может, присоединишься?"
    show dv laugh pioneer2 at left with dspr
    dv "Ха, Гром, не пугай его. Семён, милый, это не то, что ты думаешь. Просто... развлекаемся. Ты же не ревнуешь?"
    "Она подошла ближе, её глаза блестели озорством, но с лёгкой насмешкой."
    me "Ревную? Да ладно, мы же не... ну, ты знаешь. Просто... неожиданно увидеть тебя с этим... с Громом."
    show dv smile pioneer2 at left with dspr
    dv "А что, нельзя? Я свободная девочка. Но если хочешь... могу и тебе уделить время. Позже."
    "Она подмигнула, но в голосе сквозила та самая 'Алискина' игривость — как будто дразнит, проверяет реакцию."
    gr "Эй, рыжая, а как же я?"
    show dv grin pioneer2 at left with dspr
    dv "Не ревнуй, Громыч. У меня на всех хватит."
    th "Сука... Она это специально?"
    me "Ладно, не буду мешать. Увидимся."
    "Я развернулся, чтобы уйти, но Алиса схватила меня за руку."
    show dv normal pioneer2 at left with dspr
    dv "Эй, не дуйся. Это просто... ну, ты понимаешь. Но ты — особенный. Честно."
    "Её тон стал чуть мягче, но глаза всё так же искрились."
    me "Особенный? Ага, ясно."
    "Я вырвал руку и ушёл, не оглядываясь. Ревность жгла внутри, но и возбуждала — Алиса была такой... развратной и непредсказуемой."
    hide dv
    hide gr
    with dissolve
    th "Блядь, почему это так задевает? Мы же не пара... Но чёрт."
    th "С одной стороны меня дико отвращает её поведение, но с другой... почему я не могу её просто использовать? Она же просто шлюха."
    "Шлюха.., но... что-то внутри меня не даёт покоя. Я хотел быть её единственным. Не парой... нет, просто друзьями. С привилегиями."
    "Но по всей видимости привилегии были не у меня одного. Это резало меня изнутри."
    "Я побрёл обратно в домик, мысли путались. Ночь обещала быть долгой."
    
    jump as_day_3_day_night_library


label as_day_3_day_night_library:
